...
public class hasil extends JPanel {
    ...
    public void init(ruangkelasetget RKS) {
        ...
        txt15.setText("" + RKS.getKondjendela());
        ...
        txt16.setText("" + RKS.getKesimpulan());
        ...
        txt17.setText("" + RKS.getJumkontak() + " " + RKS.getPoskontak() + " " + RKS.getKondkontak());
        ...
        txt18.setText("" + RKS.getKabelLCD() + " " + RKS.getPoskabLCD() + " " + RKS.getKondkabLCD());
        ...
        txt19.setText("" + RKS.getJumLampu() + " " + RKS.getPoslampu() + " " + RKS.getKondlampu());
        ...
        txt20.setText("" + RKS.getJumKipas() + " " + RKS.getPosKipas() + " " + RKS.getKondkipas());
        ...
        txt21.setText("" + RKS.getJumAC() + " " + RKS.getPosAC() + " " + RKS.getKondAC());
        ...
        txt22.setText("" + RKS.getJumCCTV() + " " + RKS.getPosCTV() + " " + RKS.getKondCTV());
        ...
        txt23.setText("" + RKS.getSSID() +" "+ RKS.getBandwith() );
        ...
        txt24.setText("" + RKS.getSirkudara());
        ...
        txt25.setText("" + RKS.getPencahayaan());
        ...
        txt26.setText("" + RKS.getKelembapan());
        ...
        txt28.setText("" + RKS.getKebisingan());
        ...
        txt30.setText("" + RKS.getKebocoran());
        ...
        txt31.setText("" + RKS.getKerusakan());
